...
//temos duas formas de declarar uma variável em js:
var variavel1 = 'variavel com var';
let variavel2 = 'variavel com let';
...
//null 
let nulo = null; // --> Variável com valor NULO...literalmente nulo e meio inútil
// string
...
let objetoTeste = {'lista': ['elemento1', 'elemento2', 'elemento3'], 'numero': 10}; // --> isso ao lado é um objeto ({'chave-objeto': 'valor-objeto'})
